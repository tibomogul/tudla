...
FastMcp.mount_in_rails(
  ...
  allowed_origins: [ "localhost", /localhost:\d+/, "127.0.0.1", "[::1]", "middleearth.myddns.me", /.*\.middleearth\.myddns\.me/ ],
  localhost_only: false # Set to false to allow connections from other hosts
  # Note: Authentication is handled by McpAuthMiddleware in lib/mcp_auth_middleware.rb
) do |server|
