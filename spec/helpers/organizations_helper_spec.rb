...
# OrganizationsHelper is intentionally empty — it defines no methods (see
# app/helpers/organizations_helper.rb). There is no presentation logic to
...
RSpec.describe OrganizationsHelper, type: :helper do
  it "is mixed into the helper context" do
    expect(helper).to be_a(OrganizationsHelper)
  end
end
