TO DO:
- [x] Fix assigning users to tasks
- [x] Markdown editing and rendering for task descriptions
- [x] Stoplight status on projects, scopes and tasks
- [x] Add "nice-to-have" field to tasks
- [x] Post report to slack
- [x] A user to be able to change their password (specially if I auto-create them)
...
- [ ] Have conversations in the system, have channels and PMs
- [ ] Have conversations in the tasks, scopes and projects
- [ ] Show calendar events on the dashboard (needs more scoping)
